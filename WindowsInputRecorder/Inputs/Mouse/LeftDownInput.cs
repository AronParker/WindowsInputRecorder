...
{
    public class LeftDownInput : MouseInput
    {
        public LeftDownInput()
        {
        }

        public LeftDownInput(int x, int y)
            : base(x, y)       
        {
        }
        ...
        {
            return new LeftDownPacket(this);
        }
        ...
        internal override void InternalQueue(SendInput sendInput)
        {
            ...
            input.inputunion.mi.dwFlags = MOUSEEVENTF.MOVE | MOUSEEVENTF.LEFTDOWN | MOUSEEVENTF.ABSOLUTE;
