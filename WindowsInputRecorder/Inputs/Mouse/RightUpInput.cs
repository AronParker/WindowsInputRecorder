...
{
    public class RightUpInput : MouseInput
    {
        public RightUpInput()
        {
        }

        public RightUpInput(int x, int y)
            : base(x, y)       
        {
        }
        ...
        internal override void InternalQueue(SendInput sendInput)
        {
            ...
            input.inputunion.mi.dwFlags = MOUSEEVENTF.MOVE | MOUSEEVENTF.RIGHTUP | MOUSEEVENTF.ABSOLUTE;
